...
class TestMultiInstanceWorkflows:
    ...
    def test_multi_instance_parallel_workflow(self):
        ...
        execution_results = {task_id: exec_context.get_result(task_id) for task_id in ["api", "db", "cache"]}
...
class TestChannelOverride:
    ...
    def test_bound_param_overrides_channel(self):
        ...
        with workflow("override_test") as wf:
            ...
            _, exec_context = wf.execute(
                task_instance.task_id, ret_context=True, initial_channel={"value": 100, "multiplier": 5}
            )
    ...
    def test_all_params_from_channel_when_not_bound(self):
        ...
        with workflow("channel_test") as wf:
            ...
            _, exec_context = wf.execute(
                task_instance.task_id, ret_context=True, initial_channel={"value": 7, "multiplier": 3}
            )
    ...
    def test_mixed_bound_and_channel_params(self):
        ...
        with workflow("mixed_test") as wf:
            ...
            _, exec_context = wf.execute(
                task_instance.task_id, ret_context=True, initial_channel={"a": 1, "b": 2, "c": 3, "d": 4}
            )
    ...
    def test_data_processing_pipeline(self):
        ...
        def aggregate_results(ctx) -> dict:
            ...
            return {
                ...
                "total_records": sum([api_data["records"], db_data["records"], file_data["records"]]),
