> Analyze the following error and root cause and explain it and explain how to fix it. TypedChannel Messages:
  ...
  Traceback (most recent call last):
    ...
    File "/Users/myui/workspace/myui/graflow/.venv/lib/python3.10/site-packages/redis/client.py", line 606, in 
...
⏺ Error Analysis
  ...
  This error occurs during the shutdown sequence of a Redis-based distributed workflow. There are two distinct but related issues
  happening:
